...
CREATE TABLE "tag_canonical_values" (
	...
	"tag_id" uuid,
	"value" text NOT NULL,
	"search_key_words" text NOT NULL,
	"created_by_user_id" uuid NOT NULL,
	"updated_by_user_id" uuid,
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now(),
...
CREATE TABLE "tags" (
	...
	"customer_id" uuid,
	"name" text NOT NULL,
	"is_multiple_values" boolean DEFAULT false NOT NULL,
	"created_by_user_id" uuid NOT NULL,
	"updated_by_user_id" uuid,
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now(),
...
ALTER TABLE "tags" ADD CONSTRAINT "tags_updated_by_user_id_users_user_id_fk" FOREIGN KEY ("updated_by_user_id") REFERENCES "public"."users"("user_id") ON DELETE cascade ON UPDATE cascade;