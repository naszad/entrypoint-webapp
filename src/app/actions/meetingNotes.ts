...
async function generateTagSuggestions(summary: string, notes: string, studentId: string) {
...
export async function addMeetingNotes(
    ...
    try {
        ...
        const suggestedTags = await generateTagSuggestions(summary, notes, studentId);
