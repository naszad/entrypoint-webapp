-- Trying to get migrations repaired
...
revoke delete on table "public"."pipeline_error_log" from "anon";

revoke insert on table "public"."pipeline_error_log" from "anon";

revoke references on table "public"."pipeline_error_log" from "anon";

revoke select on table "public"."pipeline_error_log" from "anon";

revoke trigger on table "public"."pipeline_error_log" from "anon";

revoke truncate on table "public"."pipeline_error_log" from "anon";

revoke update on table "public"."pipeline_error_log" from "anon";

revoke delete on table "public"."pipeline_error_log" from "authenticated";

revoke insert on table "public"."pipeline_error_log" from "authenticated";

revoke references on table "public"."pipeline_error_log" from "authenticated";

revoke select on table "public"."pipeline_error_log" from "authenticated";

revoke trigger on table "public"."pipeline_error_log" from "authenticated";

revoke truncate on table "public"."pipeline_error_log" from "authenticated";

revoke update on table "public"."pipeline_error_log" from "authenticated";

revoke delete on table "public"."pipeline_error_log" from "service_role";

revoke insert on table "public"."pipeline_error_log" from "service_role";

revoke references on table "public"."pipeline_error_log" from "service_role";

revoke select on table "public"."pipeline_error_log" from "service_role";

revoke trigger on table "public"."pipeline_error_log" from "service_role";

revoke truncate on table "public"."pipeline_error_log" from "service_role";

revoke update on table "public"."pipeline_error_log" from "service_role";
